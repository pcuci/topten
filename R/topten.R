...
#' 
#' This function develops a prediction algorithm based on the top 10 
#' features in 'x' that are most predictive of 'y'
#' 
...
#' @details
#' This function runs a univariate regression of y on each predictor in x
...
#' Prediction of Top Ten Features
#' 
#' This function takes a set of coefficients produced by the \code{topten}
#' function and makes a prediction for each of the values provided
#' in the input 'X' matrix
#' 
#' @param X a nx 10 matrix containing n new observations
